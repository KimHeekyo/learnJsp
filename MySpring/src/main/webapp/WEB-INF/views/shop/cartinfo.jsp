...
<div class="container-fluid">
	<!-- Page Heading -->
	<h1 class="h3 mb-2 text-gray-800">${carttotal.m_name}님의 ${cm_code}번 장바구니목록</h1>
	<p class="mb-4"></p>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">
				<a href="/shop/list">상품리스트</a>&nbsp;&nbsp; ${carttotal.m_id}님
			</h6>
		</div>
		<div class="card-body">
			<div class="table-responsive">
					...
					<tbody>
						<c:forEach items="${list}" var="cartsub">
							<tr>
								...
								<td align="center"><img
									src="/resources/product/${cartsub.p_code}.jpg" height="50"></td>
									...
									<select name="cs_cnt">
										<c:forEach var="count" begin="1" end="30" step="1">	<!-- step은 생략 가능 -->
											<c:if test="${count == cartsub.cs_cnt}">
												<option value="${count}" selected>${count}</option>  <!-- selected는 현재의 개수의 맞게 표시해준다 -->
											</c:if>
											<c:if test="${count != cartsub.cs_cnt}">
				...
				<table class="table table-bordered" width="100%" cellspacing="0">
					...
					<tr align="center">
						<th>총가격</th>
						<td><fmt:formatNumber value="${carttotal.cm_total}" pattern="#, ###" />원</td>
