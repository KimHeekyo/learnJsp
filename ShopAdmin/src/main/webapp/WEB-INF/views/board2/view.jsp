			...
			<div class="card-body">
				<div class="form-group row">
					<div class="col-sm-6 mb-3 mb-sm-0">
						<input type="hidden" class="form-control" value="${board.b_num}"
							readonly>
					</div>
				</div>
				<div class="form-group row">
					<div class="col-sm-6 mb-3 mb-sm-0">
						<label>제목</label> <input type="text" class="form-control"
							value="${board.b_subject}" readonly>
					</div>
				</div>
				<br>
				<div class="form-group row">
				...
				<div class="form-group row">
					<div class="col-sm-6">
						<label>내용</label>
						<textarea rows="15" class="form-control" readonly>${board.b_contents}</textarea>
					</div>
				</div>
				<br>
				<div class="form-group row">
				...
				<div class="form-group row">
					<div class="col-sm-6">
						<a
							href="/board2/update?b_num=${board.b_num}&pageNum=${page.pageNum}">[수정]</a>
